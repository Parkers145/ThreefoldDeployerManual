...
#### How to find my deployments ip address?
</summary>
...
#### how to add a new worker node to your cluster
</summary>
...
![](img/enable_https_caprover.png" class="thumbnail"  width="60%" height="60%">

You need to specify your email address.

You will have to login again.

![](img/caprover_https_activated.png" class="thumbnail"  width="60%" height="60%">
...
![](img/caprover_docker_registry.png" class="thumbnail"  width="60%" height="60%">

You can check [official documentation](https://caprover.com/docs/app-scaling-and-cluster.html#setup-docker-registry) to know more about Docker registry options.
## Step 3: Deploy an app

![](img/deploy_app_caprover1.png" class="thumbnail"  width="60%" height="60%">

just go to apps & follow the instructions, there is much more info on caprover website.

## Step 4: Enable monitoring

![](img/caprover_monitoring_start_.png" class="thumbnail"  width="60%" height="60%">

You should now see

![](img/caprover_monitoring_2_.png" class="thumbnail"  width="60%" height="60%">

## Step 5: Lets add nodes to caprover

- Go to the settings

![](img/caprover_cluster.png" class="thumbnail"  width="60%" height="60%">
...
![](img/cluster_add_nodes.png" class="thumbnail"  width="60%" height="60%">
...
![](img/caprover_select_node.png" class="thumbnail"  width="60%" height="60%">

You should then see something like

![](img/caprover_add_node2.png" class="thumbnail"  width="60%" height="60%">
...
![](img/caprover_node_added.png" class="thumbnail"  width="60%" height="60%">
